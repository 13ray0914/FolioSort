...
try:
    ...
    print('Outputs:')
    for name,pattern in [('metadata','data/metadata/*.metadata.json'),('memory','data/summary_memory/*.memory.json'),('visual','data/visual_analysis/*.visual.json'),('evidence','data/extracted/*.evidence.json'),('references','data/reference_matches/*.references.json')]:
